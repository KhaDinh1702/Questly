      ...
      <div className="relative font-body text-on-surface min-h-screen flex flex-col">
        ...
        <main className="flex-grow flex items-center justify-center p-6">
          <div className="bg-surface-container-high p-12 max-w-2xl w-full text-center border-2 border-primary-container shadow-[8px_8px_0px_0px_rgba(0,0,0,0.6)]">
            ...
            <p className="text-stone-700 text-lg mb-8 italic">You have absorbed the knowledge of "{set.title}".</p>
            
            <div className="text-6xl font-headline font-bold text-primary mb-2">{finalScore}%</div>
            <p className="text-stone-600 uppercase tracking-widest text-xs font-bold mb-12">Mastery Gained</p>
            ...
            <div className="flex flex-col gap-4">
              ...
              <button 
                ...
                className="w-full border-2 border-stone-400 py-4 font-headline font-bold text-xl uppercase tracking-widest text-stone-700 hover:bg-stone-200 transition-colors active:translate-y-1"
              >
                Study Again
              </button>
              <button 
            ...
            {saving && <p className="text-xs text-stone-600 mt-4 animate-pulse">Recording progress in the archives...</p>}
          </div>
        </main>
      </div>
    );
  ...
  return (
    <div className="relative font-body text-on-surface min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 w-full max-w-4xl mx-auto">
          ...
          {!isFlipped ? (
            ...
            <div className="w-full h-full bg-surface-container border-2 border-stone-600 shadow-[8px_8px_0px_0px_rgba(0,0,0,0.5)] flex items-center justify-center p-8 group-hover:border-primary transition-colors animate-in fade-in zoom-in duration-300">
              <div className="text-center">
                <span className="block text-primary uppercase text-xs font-bold tracking-widest mb-4">Term</span>
            ...
            <div className="w-full h-full bg-surface-container-high border-2 border-tertiary shadow-[8px_8px_0px_0px_rgba(0,0,0,0.5)] flex flex-col items-center justify-center p-8 animate-in fade-in zoom-in duration-300">
              <div className="text-center w-full h-full flex flex-col items-center justify-center">
                <span className="block text-primary uppercase text-xs font-bold tracking-widest mb-4">Definition</span>
        ...
        <p className={`mt-6 text-stone-600 italic text-sm transition-opacity duration-300 ${!isFlipped ? 'opacity-100' : 'opacity-0'}`}>
